<template>
  ...
  <el-menu :default-active="rootMenusSelectedCode" class="navbar" mode="horizontal">
    ...
    <div v-else class="menu-first">
      <el-menu-item v-for="(item,index) in rootMenus" v-if="index<4" :router="true" :index="item.code.toString()"
                    :key="item.id">
    ...
    <password v-if="visiblePassword" visiblePassword @confirm="confirm"/>
  </el-menu>
</template>
