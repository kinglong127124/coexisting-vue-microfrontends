<template>
  <div class="calendar-list-container">
    <div class="handler-container">
      <el-button v-if="menuManager_btn_add" type="primary" icon="el-icon-plus" size="small" plain @click="handlerRoot">
        新增根
      </el-button>
      <el-button
            ...
            <el-collapse-item title="基本信息" name="1">
              ...
              <el-form
                ...
                <el-row :gutter="10">
                  ...
                  <el-col v-show="false" :span="8">
                    <el-form-item label="前端组件" prop="attr1">
                      <el-input v-model="form.attr1" :disabled="formEdit" clearable size="small" placeholder="请输入前端组件"/>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :class="{disabled:formEdit}" label="是否显示" prop="enabled" class="add-border">
                ...
                <el-row :gutter="10">
                  ...
                  <!--v-for="(row) in dataEnum.isOrNot" :key="row.code">-->
                  <!--{{ row.name }}-->
                  <!--</el-radio>-->
                  <!--</el-radio-group>-->
                  <!--</el-form-item>-->
                ...
                <el-row :gutter="10">
                  <el-col :span="8">
                    <el-form-item :class="{disabled:formEdit}" label="是否手机端可用" class="add-border">
                      <el-radio-group v-model="form.attr7" :disabled="formEdit">
                        <el-radio
                          v-for="(row) in dataEnum.isOrNot"
                          :label="row.code"
                          :key="row.code">
                  ...
                  <!-- <el-col :span="16">
                    <el-form-item label="手机端路由">
                      <el-input clearable size="small" v-model="form.attr8" :disabled="formEdit || urlDisbelsd" placeholder="请输入手机端路由"></el-input>
                    </el-form-item>
                  </el-col> -->
                </el-row>
              </el-form>
...
} from '@/api/custormManager/sysInfo/menu';
  ...
  methods: {
    ...
    resetForm() {
      this.form = {
        ...
        description: undefined,
        path: undefined,
        attr7: String(this.dataEnum.static.isOrNot[1].code),
        ifCanOverflow: parseInt(this.dataEnum.static.isOrNot[1].code),
        enabled: String(this.dataEnum.static.isOrNot[0].code),
