          ...
          <div class="right-container white">
            ...
            <el-form
              ...
              <el-form-item label="编码">
                <el-input v-model="modelUnitTypeForm.code" clearable size="small" disabled/>
              </el-form-item>
...
import {
  ...
  deleteUnitType,
  addOrUpdateUnitType
} from '@/api/custormManager/sysBaseSet/sysUnitTypeInfo';
import {
  getNowFormatDate,
  deepCloneByObject,
  ...
  methods: {
    ...
    clickLevel(type, pid) {
      ...
      if (type == 1 && pid == -1) {
        ...
        // 新增同级
        const treeId = this.modelUnitTypeForm.tree_id + '-' + (this.$utils.length(this.modelUnitTypeForm.children) > 0 ? this.modelUnitTypeForm.children.length : '0');
        this.$set(addRowData, 'tree_id', treeId);
        this.$set(addRowData, 'treeId', treeId);
