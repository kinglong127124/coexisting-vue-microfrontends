...
export function getMeasureUnit(obj) {
  return request({
    url: '/api/smartpm/sysConfigUnits/page',
    method: 'get',
    params: obj
  });
}
...
export function addMeasureUnit(list) {
  return request({
    url: '/api/smartpm/sysConfigUnits/addEntityList',
    method: 'post',
    data: list
  });
}
...
export function deleteMeasureUnit(id) {
  return request({
    url: '/api/smartpm/sysConfigUnits/' + id,
    method: 'delete'
  });
}
...
export function configMeasureUnit(row) {
  return request({
    url: '/api/smartpm/sysConfigUnits/audit',
    method: 'put',
    data: row
  });
}
...
export function putSysConfigUnits(obj) {
  return request({
    url: '/api/smartpm/sysConfigUnits/enable',
    method: 'put',
    data: obj
  });
}
