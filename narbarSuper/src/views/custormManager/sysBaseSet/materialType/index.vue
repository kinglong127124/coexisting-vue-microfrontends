          ...
          <div class="right-container white">
            ...
            <el-form
              ...
              <el-form-item label="编码">
                <el-input v-model="modelMaterialTypeForm.code" clearable size="small" disabled/>
              </el-form-item>
...
} from '@/api/custormManager/sysBaseSet/materialType';
import {
  getNowFormatDate,
  deepCloneByObject,
  ...
  methods: {
    ...
    clickLevel(type, pid) {
      ...
      if (type == 1 && pid == -1) {
        ...
        const row = { tree_parent: '', tree_id: treeId, treeId: treeId };
        ...
        // 新增同级
        const treeId = this.modelMaterialTypeForm.tree_id + '-' + (this.$utils.length(this.modelMaterialTypeForm.children) > 0 ? this.modelMaterialTypeForm.children.length : '0');
        this.$set(addRowData, 'tree_id', treeId);
        this.$set(addRowData, 'treeId', treeId);
