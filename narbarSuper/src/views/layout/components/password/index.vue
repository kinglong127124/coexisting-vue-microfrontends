<template>
  <basic-dialog v-el-drag-dialog :visible.sync="visiblePassword" title="修改密码" width="30" :show-close="false">
    <el-form ref="refModelForm" :model="modelForm" :rules="rules" :show-message="false" label-width="120px"
             class="modelForm-container" auto-complete="off" autocomplete="off">
      ...
      <el-form-item label="新密码" prop="newPassword">
        <el-input ref="refNewPassword" v-model="modelForm.newPassword" clearable size="small" type="password"
                  placeholder="请输入新密码"
                  auto-complete="off"
                  autocomplete="off"
        />
      ...
      <el-form-item label="确认新密码" prop="newPasswordConfirm">
        <el-input ref="refNewPasswordConfirm" v-model="modelForm.newPasswordConfirm" clearable size="small"
                  type="password"
...
<script>
  ...
  import { validateLength, validateRegex, isValidEleven } from '@/utilsCom/validate'
