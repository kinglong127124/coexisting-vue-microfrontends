<template>
  <div>
    <div class="handler-container">
      <el-button
        v-if="userManagerDetail_btn_add"
        type="primary"
        size="small"
        icon="el-icon-plus"
        plain
      ...
      <el-button
        v-if="userManagerDetail_btn_edit"
        type="primary"
        size="small"
      ...
      <el-button
        v-if="userManagerDetail_btn_delete"
      ...
      <el-button
        v-if="userManagerDetail_btn_audit"
      ...
      <el-button
        v-if="userManagerDetail_btn_disenable"
      ...
      <el-button
        v-if="userManagerDetail_btn_enable"
        ...
        <split-pane :min-percent="30" :default-percent="60" split="vertical">
          <template slot="paneL">
            <div class="left-container">
              <div class="handler-container">
                <el-button
                  v-if="this.elements['userManagerDetailStation:btn_add']"
                  type="primary"
                  size="small"
                  icon="el-icon-plus"
                  plain
                ...
                <el-button
                  v-if="this.elements['userManagerDetailStation:btn_delete']"
                ...
                <el-button
                  v-if="this.elements['userManagerDetailStation:btn_setStation']"
          ...
          <template slot="paneR">
            <div class="right-container">
              <div class="handler-container">
                <el-button
                  v-if="this.elements['userManagerDetailRoles:btn_add']"
                  type="primary"
                  size="small"
                  icon="el-icon-plus"
                  plain
                ...
                <el-button
                  v-if="this.elements['userManagerDetailRoles:btn_delete']"
...
import { deepCloneByObject, logout } from '@/utilsCom/index';
import { validatePhone, validateLength } from '@/utilsCom/validate';
