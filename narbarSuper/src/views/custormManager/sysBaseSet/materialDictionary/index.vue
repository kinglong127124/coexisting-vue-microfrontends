        ...
        <template slot="paneR">
          <div class="right-container">
            ...
            <el-table
              ...
              <el-table-column align="center" label="编码" prop="code" min-width="100" show-overflow-tooltip/>
              <el-table-column
                label="名称(*)"
                prop="name"
                ...
                <template slot-scope="scope">
                  <span v-if="validateStatus(scope)">{{ scope.row.name }}</span>
                  <el-form
                    v-else
              ...
              <el-table-column
                ...
                show-overflow-tooltip>
                <template slot-scope="scope">
                  <span v-if="validateStatus(scope)">{{ scope.row.model }}</span>
                  <el-form
                    v-else
                    :model="tableData.data[scope.$index]"
              ...
              <el-table-column
                ...
                show-overflow-tooltip>
                <template slot-scope="scope">
                  <span v-if="validateStatus(scope)">{{ scope.row.unit }}</span>
                  <el-select
                    v-else
                    :disabled="validateStatus(scope)"
              ...
              <el-table-column
                ...
                show-overflow-tooltip>
                <template slot-scope="scope">
                  <span v-if="validateStatus(scope)">{{ formatToThousandsFour(scope.row.price) }}</span>
                  <basic-input
                    v-else
              ...
              <el-table-column
                ...
                show-overflow-tooltip>
                <template slot-scope="scope">
                  <span v-if="validateStatus(scope)">{{ scope.row.remark }}</span>
                  <basic-tooltip v-else :data="scope.row.remark">
                    <el-input
...
import { validateLength } from '@/utilsCom/validate';
...
import {
  ...
  deleteDic,
  enableDic
} from '@/api/custormManager/sysBaseSet/materialDictionary';
